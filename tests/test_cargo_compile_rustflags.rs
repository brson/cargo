...
test!(host_rustflags_normal_source {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(host_rustflags_build_script {
    // RUSTFLAGS should be passed to rustc for build scripts
    // when --target is not specified.
    // In this test if --cfg foo is passed the build will fail.
    let p = project("foo")
...
test!(host_rustflags_build_script_dep {
    // RUSTFLAGS should be passed to rustc for build scripts
    // when --target is not specified.
    // In this test if --cfg foo is not passed the build will fail.
    let foo = project("foo")
...
test!(host_rustflags_plugin_dep {
    // RUSTFLAGS should be passed to rustc for plugins
    // when --target is not specified.
    // In this test if --cfg foo is not passed the build will fail.
    let foo = project("foo")
...
test!(host_rustflags_normal_source_with_target {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
    ...
    // Since --target was specified, target.rustflags is ignored
    // in favor of target.$triple.rustflags.
    assert_that(p.cargo("build")
                .arg("--lib").arg("--target").arg(host),
                execs().with_status(0));
    assert_that(p.cargo("build")
...
test!(host_rustflags_build_script_dep_with_target {
    // RUSTFLAGS should not be passed to rustc for build scripts
    // when --target is specified.
    // In this test if --cfg foo is passed the build will fail.
    let foo = project("foo")
...
test!(host_rustflags_plugin_with_target {
    // RUSTFLAGS should not be passed to rustc for plugins
    // when --target is specified.
    // In this test if --cfg foo is passed the build will fail.
    let p = project("foo")
...
test!(host_rustflags_plugin_dep_with_target {
    // RUSTFLAGS should not be passed to rustc for plugins
    // when --target is specified.
    // In this test if --cfg foo is passed the build will fail.
    let foo = project("foo")
...
test!(host_rustflags_recompile2 {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(host_rustflags_no_recompile {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_normal_source {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_build_script {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_build_script_dep {
    let foo = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_plugin_dep {
    let foo = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_normal_source_with_target {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_build_script_dep_with_target {
    let foo = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_plugin_with_target {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_plugin_dep_with_target {
    let foo = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_recompile {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_recompile2 {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
...
test!(target_rustflags_no_recompile {
    let p = project("foo")
        .file("Cargo.toml", r#"
            [package]
            name = "foo"
